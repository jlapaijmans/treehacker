...
test_that("TREEhacker runs successfully",{
  res <- system2("../TREEhacker_1.0.sh"," fastafiles.txt test 20 20 0.5 BOTH",
          stdout=TRUE)
...
test_that("TREEhacker filters windows properly",{
  res <- system2("../TREEhacker_1.0.sh"," fastafiles.txt test 20 20 0.5 DNA",
          stdout=TRUE)
  ...
  res <- system2("../TREEhacker_1.0.sh"," fastafiles.txt test 20 20 0.1 DNA",
          stdout=TRUE)
